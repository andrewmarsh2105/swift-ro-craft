...
import { dashboardDesktopHeader as dashboardDesktopHeaderLogoHeightPx } from "@/components/brand/logoSizing";
    ...
    <div className="h-full min-h-0 overflow-hidden flex flex-col bg-muted/20">
      ...
      <div className="app-bar">
        <div className="flex items-center min-w-0 gap-2.5">
          <HeaderLogo height={dashboardDesktopHeaderLogoHeightPx} />
        </div>
