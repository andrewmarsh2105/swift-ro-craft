...
export const ALL_COLUMNS: ColumnDef[] = [
  { id: 'roNumber', label: 'RO #', minWidth: 76, align: 'left', isRoLevel: true },
  { id: 'date', label: 'Date', minWidth: 78, align: 'left', isRoLevel: true },
  { id: 'advisor', label: 'Advisor', minWidth: 88, align: 'left', isRoLevel: true },
  { id: 'customer', label: 'Customer', minWidth: 100, align: 'left', isRoLevel: true },
  { id: 'vehicle', label: 'Vehicle', minWidth: 100, align: 'left', isRoLevel: true },
  { id: 'lineNo', label: 'Line', minWidth: 44, align: 'center', isRoLevel: false },
  { id: 'description', label: 'Work Performed', minWidth: 200, align: 'left', isRoLevel: false, wrap: true },
  { id: 'hours', label: 'Hours', minWidth: 58, align: 'right', isRoLevel: false },
  { id: 'type', label: 'Type', minWidth: 52, align: 'center', isRoLevel: false },
  { id: 'roTotal', label: 'RO Total', minWidth: 72, align: 'right', isRoLevel: true },
