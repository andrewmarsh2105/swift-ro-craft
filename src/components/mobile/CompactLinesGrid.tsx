...
export function CompactLinesGrid({ 
  ...
  return (
    <div className="space-y-2" ref={topRef}>
      {/* Preset Quick Add - Horizontal strip */}
                  ...
                  {!readOnly && (
                    <div className="flex items-center gap-0.5 flex-shrink-0">
                      <button
                        ...
                        className="p-1.5 text-muted-foreground hover:text-foreground rounded min-w-[32px] min-h-[32px] flex items-center justify-center"
                      >
                        <Copy className="h-3.5 w-3.5" />
                      </button>
                      <button
                        onClick={() => handleRemoveLine(index)}
                        className="p-1.5 text-destructive/70 hover:text-destructive rounded min-w-[32px] min-h-[32px] flex items-center justify-center"
                      >
                ...
                <div className="flex items-center gap-2 pl-7">
                  ...
                  <div className="flex items-center gap-1">
                    <input
                      ...
                      placeholder="0.0"
                      disabled={readOnly}
                      className="w-16 h-8 px-2 bg-background rounded text-sm font-semibold text-right focus:outline-none focus:ring-1 focus:ring-primary disabled:opacity-60"
                    />
