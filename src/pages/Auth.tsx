    ...
    <div className="min-h-screen flex">
      ...
      >
        ...
        <div className="relative flex flex-col h-full p-10">
          {/* Logo */}
          <HeaderLogo priority height={160} className="max-w-[420px]" />
        ...
        <div className="flex-1 flex items-center justify-center p-6">
          ...
          >
            ...
            <div className="flex items-center justify-center md:hidden">
              <HeaderLogo priority height={120} className="max-w-[340px]" />
            </div>
            ...
            <div className="space-y-2.5">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 h-11 rounded-lg border border-border bg-foreground text-background hover:opacity-90 transition-opacity text-sm font-medium"
              >
