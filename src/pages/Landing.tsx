...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen">
      ...
      >
        <div className="max-w-[1200px] mx-auto flex items-center justify-between h-[160px] px-4 md:px-8">
          <Link
            to="/"
          ...
          >
            <img
              ...
              decoding="async"
              draggable={false}
              className="block h-[120px] w-auto max-w-[480px] shrink-0 select-none object-contain sm:h-[132px] sm:max-w-[560px] lg:h-[144px] lg:max-w-[680px]"
            />
          </Link>
      ...
      {/* ── Hero ────────────────────────────────────────────── */}
      <section
        className="px-4 md:px-8 pt-12 pb-16 md:pt-20 md:pb-28"
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            >
              ...
              <div className="flex items-center gap-2.5">
                <span className="w-5 h-px" style={{ background: AMBER }} />
                <span
              ...
              {/* Headline */}
              <h1 className="font-display text-[2.4rem] sm:text-[2.75rem] md:text-[3.25rem] lg:text-[3.75rem] font-bold tracking-tight leading-[1.08] text-white">
                Stop leaving<br />
                hours on<br />
                the table.
              </h1>
              ...
              {/* Sub */}
              <p className="text-[15px] md:text-lg leading-relaxed text-slate-400 max-w-[400px]">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-1">
                <Link
                  to="/auth"
                  className="inline-flex items-center gap-2 px-8 text-[15px] font-bold tracking-[0.01em] rounded-[3px] transition-opacity hover:opacity-90"
                  style={{
                    background: 'linear-gradient(135deg, hsl(37,86%,50%) 0%, hsl(37,86%,40%) 100%)',
                    color: NAVY,
                    height: '52px',
                    boxShadow: '0 1px 0 0 rgba(255,255,255,0.12) inset, 0 2px 12px rgba(212,137,10,0.25)',
                  }}
                >
          ...
          <div className="grid grid-cols-2 md:hidden">
            {statItems.map((stat, i) => (
              <div
                ...
                style={{
                  borderRight: i % 2 === 0 ? '1px solid rgba(12,24,41,0.12)' : undefined,
                  borderBottom: i < 2 ? '1px solid rgba(12,24,41,0.12)' : undefined,
                }}
              >
                <div className="text-sm font-bold tabular-nums" style={{ color: NAVY }}>{stat.value}</div>
                <div className="text-[11px] font-medium mt-0.5" style={{ color: 'rgba(12, 24, 41, 0.52)' }}>{stat.label}</div>
              </div>
            ))}
          </div>

          {/* Desktop: horizontal row */}
          <div className="hidden md:flex items-center justify-center gap-12 lg:gap-16 py-4 px-8">
            {statItems.map((stat, i) => (
      ...
      {/* ── Problem statement ───────────────────────────────── */}
      <section className="py-14 md:py-24 px-4 md:px-8 bg-white">
        <div className="max-w-[1100px] mx-auto">
          <div className="max-w-3xl">
            <p className="text-[11px] font-mono font-semibold uppercase tracking-[0.2em] text-slate-400 mb-5">
              The problem
            </p>
            <h2
              className="font-display text-[1.85rem] md:text-[2.75rem] lg:text-[3.25rem] font-bold tracking-tight leading-[1.12]"
              style={{ color: NAVY }}
            >
              Most techs have no record of what they worked.
              <br className="hidden md:block" /> Until payday — when it's too late.
            </h2>
            <p className="text-[15px] md:text-lg text-slate-500 leading-relaxed mt-6 max-w-xl">
      ...
      {/* ── How it works ────────────────────────────────────── */}
      <section id="how-it-works" className="py-12 md:py-24 px-4 md:px-8 scroll-mt-16" style={{ background: '#F7F4EF' }}>
        <div className="max-w-[1100px] mx-auto">
          <div className="grid md:grid-cols-[220px_1fr] lg:grid-cols-[280px_1fr] gap-8 md:gap-16 items-start">
            ...
            <div className="md:sticky md:top-24">
              ...
              <h2 className="text-[1.6rem] md:text-3xl font-bold tracking-tight leading-[1.15]" style={{ color: NAVY }}>
            ...
            <div>
              {steps.map((step, i) => (
                <motion.div
                  key={step.num}
                  className="flex gap-5 md:gap-8 py-7 items-start"
                ...
                >
                  <span
                    className="font-display text-[2.75rem] md:text-[3.5rem] font-black tabular-nums leading-none flex-shrink-0 w-12 md:w-14 text-right"
                    style={{ color: AMBER }}
                  >
                    0{step.num}
                  </span>
            ...
            <div>
              {outcomes.map((o, i) => (
                <motion.div
                  ...
                  custom={i}
                >
                  <span className="text-[11px] font-mono text-slate-400 pt-0.5 flex-shrink-0 w-5">
                    0{i + 1}
                  </span>
                  <div>
                    <h3 className="text-[15px] font-bold mb-1.5" style={{ color: NAVY }}>{o.title}</h3>
      ...
      <section id="screenshots" className="py-12 md:py-24 px-4 md:px-8 scroll-mt-16" style={{ background: '#F7F4EF' }}>
        <div className="max-w-[1100px] mx-auto">
          <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-[1.6rem] md:text-3xl font-bold tracking-tight leading-[1.15] mb-4" style={{ color: NAVY }}>
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={t} className="flex items-center gap-3 text-[14px] text-slate-600">
      ...
      <section style={{ background: NAVY }} className="py-12 md:py-24 px-4 md:px-8">
        <div className="max-w-[1100px] mx-auto">
          <div className="mb-10 md:mb-12">
            <p className="text-[11px] font-mono font-semibold uppercase tracking-[0.2em] mb-4" style={{ color: AMBER }}>
              Pro plan
            </p>
            <h2 className="font-display text-[1.6rem] md:text-3xl font-bold tracking-tight text-white">
              What Pro unlocks
            </h2>
          </div>
      ...
      {/* ── Pricing ─────────────────────────────────────────── */}
      <section id="pricing" className="py-12 md:py-24 px-4 md:px-8 scroll-mt-16 bg-white">
        <div className="max-w-[820px] mx-auto">
          ...
          <div className="mb-10 md:mb-14">
            ...
            <h2 className="text-[1.6rem] md:text-3xl font-bold tracking-tight" style={{ color: NAVY }}>
              Simple, honest pricing.
            </h2>
            <p className="text-sm text-slate-500 mt-2">Start free. Upgrade when you need more.</p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-4 md:gap-6">
            ...
            >
              <div>
                ...
                <div className="text-xs text-slate-400 mt-1.5">No credit card, no expiration.</div>
              </div>
              ...
              <Link
                to="/auth"
                className="flex items-center justify-center h-11 border text-sm font-semibold rounded-[3px] transition-all hover:bg-slate-50"
                style={{ borderColor: 'rgba(12,24,41,0.2)', color: NAVY }}
              >
                Get Started Free
              </Link>
            </motion.div>
            ...
            >
              <div>
                ...
                <div className="text-xs text-slate-500 mt-1.5">or $79.99/yr — saves you $27.89</div>
              </div>
              <ul className="space-y-2.5 flex-1">
                {proFeatures.map((f) => (
              ...
              <div className="space-y-2">
                <Link
                  to="/auth"
                  className="flex items-center justify-center h-11 text-sm font-bold rounded-[3px] transition-opacity hover:opacity-90"
                  style={{
                    background: 'linear-gradient(135deg, hsl(37,86%,50%) 0%, hsl(37,86%,40%) 100%)',
                    color: NAVY,
      ...
      {/* ── FAQ ─────────────────────────────────────────────── */}
      <section id="faq" className="py-12 md:py-24 px-4 md:px-8 scroll-mt-16" style={{ background: '#F7F4EF' }}>
        <div className="max-w-[700px] mx-auto">

          <div className="mb-10">
            <p className="text-[11px] font-mono font-semibold uppercase tracking-[0.2em] text-slate-400 mb-4">FAQ</p>
            <h2 className="text-[1.6rem] md:text-3xl font-bold tracking-tight" style={{ color: NAVY }}>
              Questions & answers
            </h2>
          </div>
      ...
      {/* ── Final CTA ───────────────────────────────────────── */}
      <section style={{ background: NAVY }} className="py-16 md:py-28 px-4 md:px-8 relative overflow-hidden">
        {/* Amber gradient accent — visible on all sizes */}
        <div
          className="absolute inset-y-0 right-0 w-2/3 pointer-events-none"
          style={{ background: 'linear-gradient(270deg, rgba(212, 137, 10, 0.06) 0%, transparent 70%)' }}
        />
        {/* Subtle top highlight */}
        <div
          className="absolute top-0 left-0 right-0 h-px pointer-events-none"
          style={{ background: 'linear-gradient(90deg, transparent 0%, rgba(212, 137, 10, 0.2) 40%, transparent 100%)' }}
        />
        <motion.div
        ...
        >
          <div className="max-w-2xl">
            <p
              className="text-[11px] font-mono font-semibold uppercase tracking-[0.2em] mb-5"
              style={{ color: AMBER }}
            >
              Get started today
            </p>
            <h2 className="font-display text-[2rem] md:text-5xl lg:text-[3.5rem] font-bold tracking-tight leading-[1.1] text-white mb-5">
              Stop guessing.<br />
              Start knowing.
            </h2>
            ...
            <div className="flex flex-wrap items-center gap-3">
              <Link
                ...
                style={{
                  ...
                  color: NAVY,
                  height: '52px',
                  boxShadow: '0 1px 0 0 rgba(255,255,255,0.12) inset, 0 2px 12px rgba(212,137,10,0.2)',
                }}
              >
              ...
              <Link
                to="/auth"
                className="inline-flex items-center px-7 h-[52px] text-sm font-medium border rounded-[3px] text-white transition-all hover:bg-white/5"
